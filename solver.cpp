...
// + operator
        ...
        //* operator
        ComplexVariable operator*(const ComplexVariable& x, const ComplexVariable &y){
            if(x.a()!=complex<double >(0.0,0.0) && y.a()!=complex<double >(0.0,0.0))
                throw out_of_range("the power is greater than 2!");
            if(x.a()!=complex<double >(0.0,0.0) && y.b()!=complex<double >(0.0,0.0))
                throw out_of_range("the power is greater than 2!");
            if(x.b()!=complex<double >(0.0,0.0) && y.a()!=complex<double >(0.0,0.0))
                throw out_of_range("the power is greater than 2!");
        ...
        if(result.a() == complex<double >(0.0,0.0) && result.b() == complex<double >(0.0,0.0) && result.c() == complex<double >(0.0,0.0))
        {
            return ComplexVariable(0, 0, 1);
        }
        if(x.a() != complex<double >(0.0,0.0) && x.b() == complex<double >(0.0,0.0) && x.c() == complex<double >(0.0,0.0) 
        && y.a() != complex<double >(0.0,0.0) && y.b() == complex<double >(0.0,0.0) && y.c() == complex<double >(0.0,0.0))
        { 
        ...
        if(y.a() == complex<double >(0.0,0.0) && y.b() == complex<double >(0.0,0.0))
        { 
            return x/y.c();
        }
...
//////////solve///////////
        ...
        complex<double> r = b*b-complex<double >(4.0,0.0)*a*c;
          
        /**if(r==complex(0.0,0.0,0.0))
                return (-b)/(a*complex(2.0,0.0));
*/
        return (-b+sqrt(r))/(complex<double >(2.0,0.0)*a);
